...
class Wav2Vec2MTL(nn.Module):
    ...
    def forward(self,
        ...
        w2v2_model_outputs = self.wav2vec2_model(audio_features, attention_mask=attention_mask, output_hidden_states=True)
        ...
        if 'asr' in mtl_head:
            ...
            conv_output_len = self.wav2vec2_model._get_feat_extract_output_lengths(attention_mask.sum(dim=1))
